...
int main()
{
	...
	unsigned char* srcImg8=nmppsMalloc_8u(size);	// Allocate source image buffer with guard fields of two rows
	unsigned char* dstImg8=nmppsMalloc_8u(size);	// Allocate result image buffer 
