...
int main()
{
	...
	unsigned char* srcImg8=(unsigned char*) malloc32(size/4,0);	// Allocate source image buffer with guard fields of two rows
	unsigned char* dstImg8=(unsigned char*) malloc32(size/4,0);	// Allocate result image buffer 
