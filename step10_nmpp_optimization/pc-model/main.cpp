...
int main()
{
	...
	unsigned char* srcImg8=(unsigned char*) shared_malloc32(size/4);	// Allocate source image buffer with guard fields of two rows
	unsigned char* dstImg8=(unsigned char*) shared_malloc32(size/4);	// Allocate result image buffer 
	...
	free32(srcImg8);	// Free source image buffer 
