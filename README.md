...
1. При работе с платой в автономном режиме MAC-адрес задается либо с помощью переменной окуржения. ```
MB7707_MAC
```  
...
5. В host-target приложении переменная определяется в **main.cpp**
```
