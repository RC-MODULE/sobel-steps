...
Для досупа приложений к плате MB77.07 используется переменная окружения ``` MB7707MAC ``` , содержащая MAC-адрес сетевого адаптера, подключенного к плате MB77.07.
