...
- vdu7707 (библиотека для работы с видео-контроллером со стороны nmc)

Хотя некоторые пакеты могут изначально присутствовать у пользователя, для обеспечения совместимости версий и
...
*/sobel-steps/deps/dev-pack-master* и дальше вызываются оттуда. При этом никаких изменений переменных окружения в системе не требуется и не производится.
