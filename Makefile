...
clean:
	$(MAKE) -C step00_easybmp_prototype\pc-pc-model\make_vs08 clean
	$(MAKE) -C step00_easybmp_prototype\pc-pc-model\make_vs13 clean
	$(MAKE) -C step01_easybmp_port2nmc\pc-pc-model\make_vs08 clean
	$(MAKE) -C step01_easybmp_port2nmc\pc-pc-model\make_vs13 clean
	...
	$(MAKE) -C step03_easybmp_nmpp\pc-pc-model\make_vs08 clean
	$(MAKE) -C step03_easybmp_nmpp\pc-pc-model\make_vs13 clean
	...
	$(MAKE) -C step04_vshell_nmpp\pc-pc-model\make_vs08 clean
	$(MAKE) -C step04_vshell_nmpp\pc-pc-model\make_vs13 clean
	...
	$(MAKE) -C step05_filter_optimization\pc-pc-model\make_vs08 clean
	$(MAKE) -C step05_filter_optimization\pc-pc-model\make_vs13 clean
	...
	$(MAKE) -C step06_class\pc-pc-model\make_vs08 clean
	$(MAKE) -C step06_class\pc-pc-model\make_vs13 clean
	...
	$(MAKE) -C step14_max_performance\pc-model\make_vs08 clean
	$(MAKE) -C step14_max_performance\pc-model\make_vs13 clean
...
all:
	$(MAKE) -C step00_easybmp_prototype\pc-pc-model\make_vs08
	$(MAKE) -C step00_easybmp_prototype\pc-pc-model\make_vs13
	$(MAKE) -C step01_easybmp_port2nmc\pc-pc-model\make_vs08 
	$(MAKE) -C step01_easybmp_port2nmc\pc-pc-model\make_vs13 
	$(MAKE) -C step02_easybmp_risc\mb7707\nm 
	...
	$(MAKE) -C step03_easybmp_nmpp\pc-pc-model\make_vs08 
	$(MAKE) -C step03_easybmp_nmpp\pc-pc-model\make_vs13 
	$(MAKE) -C step04_vshell_nmpp\mb7707\nm 
	...
	$(MAKE) -C step04_vshell_nmpp\pc-pc-model\make_vs08 
	$(MAKE) -C step04_vshell_nmpp\pc-pc-model\make_vs13 
	$(MAKE) -C step05_filter_optimization\mb7707\nm 
	...
	$(MAKE) -C step05_filter_optimization\pc-pc-model\make_vs08 
	$(MAKE) -C step05_filter_optimization\pc-pc-model\make_vs13 
	$(MAKE) -C step06_class\mb7707\nm 
	...
	$(MAKE) -C step06_class\pc-pc-model\make_vs08 
	$(MAKE) -C step06_class\pc-pc-model\make_vs13 
	$(MAKE) -C step07_internal_memory\mb7707\nm 
