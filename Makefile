...
clean:
	...
	$(MAKE) -C step07_internal_memory\model\make_vs08 clean
	...
	$(MAKE) -C step08_edge_removal\model\make_vs08 clean
	...
	$(MAKE) -C step10_nmpp_optimization\model\make_vs08 clean
	...
	$(MAKE) -C step11_filter3h\model\make_vs08 clean
	...
	$(MAKE) -C step12_filter3v\model\make_vs08 clean
	...
	$(MAKE) -C step13_memory_optimization\model\make_vs08 clean
	...
	$(MAKE) -C step14_max_performance\model\make_vs08 clean
	$(MAKE) -C step14_max_performance\model\make_vs13 clean
...
all:
	...
	$(MAKE) -C step07_internal_memory\model\make_vs08 
	$(MAKE) -C step08_edge_removal\mb7707\nm 
	...
	$(MAKE) -C step08_edge_removal\model\make_vs08 
	$(MAKE) -C step09_profiling\mb7707\nm 
	...
	$(MAKE) -C step10_nmpp_optimization\model\make_vs08 
	$(MAKE) -C step11_filter3h\mb7707\nm 
	...
	$(MAKE) -C step11_filter3h\model\make_vs08 
	$(MAKE) -C step12_filter3v\mb7707\nm 
	...
	$(MAKE) -C step12_filter3v\model\make_vs08 
	$(MAKE) -C step13_memory_optimization\mb7707\nm 
	...
	$(MAKE) -C step13_memory_optimization\model\make_vs08 
	$(MAKE) -C step14_max_performance\mb7707\nm 
	...
	$(MAKE) -C step14_max_performance\model\make_vs08 
	$(MAKE) -C step14_max_performance\model\make_vs13 
	$(MAKE) -C step15_hdmi_sd\mb7707\nm 
